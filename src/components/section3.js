...
function Section3() {
    return(
        <div className="container section3" id="sectionWhyUs">
            ...
            <div className="row">
                <div className="col-lg me-lg-5 borderSection3">
                    <div className="borderContent">
                        ...
                        <div id="mobilLengkap1">Mobil Lengkap</div>
                        <div id="mobilLengkap2">
                ...
                <div className="col-lg me-lg-5 borderSection3">
                    <div className="borderContent">
                        ...
                        <div id="hrgMurah1">Harga Murah</div>
                        <div id="hrgMurah2">
                ...
                <div className="col-lg me-lg-5 borderSection3">
                    <div className="borderContent">
                        ...
                        <div id="layanan1">Layanan 24 Jam</div>
                        <div id="layanan2">
                ...
                <div className="col-lg borderSection3">
                    <div className="borderContent">
                        <svg
                        width="32"
                        height="32"
                        ...
                        <div id="sopirProf1">Sopir Profesional</div>
                        <div id="sopirProf2">
